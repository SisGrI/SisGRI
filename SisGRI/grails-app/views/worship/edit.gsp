...
<html>
	...
	<body>
		<a href="#edit-worship" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-worship" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:worshipInstance, action:'update']" method="PUT" >

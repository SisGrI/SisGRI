	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.batism}">
				<li class="fieldcontain">
					<span id="batism-label" class="property-label"><g:message code="person.batism.label" default="Batism" /></span>
					
						<span class="property-value" aria-labelledby="batism-label"><g:formatDate date="${personInstance?.batism}" /></span>

...
<html>
	...
	<body>
		<a href="#edit-exit" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-exit" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:exitInstance, action:'update']" method="PUT" >

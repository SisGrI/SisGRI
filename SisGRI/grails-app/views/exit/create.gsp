...
<html>
	...
	<body>
		<a href="#create-exit" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-exit" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:exitInstance, action:'save']" >
				<fieldset class="form">

...
<html>
	...
	<body>
		<a href="#edit-church" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-church" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:churchInstance, action:'update']" method="PUT" >

...
<html>
	...
	<body>
		<a href="#edit-headquarter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-headquarter" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:headquarterInstance, action:'update']" method="PUT" >

    ...
    var handleDateRangePickers = function () {
        ...
        $('#defaultrange').daterangepicker({
            ...
            function (start, end) {
                ...
                $('#defaultrange input').val(start.format('DDDD M, YYYY') + ' - ' + end.format('DDDD M, YYYY'));
            }
        );
        ...
        $('#defaultrange_modal').daterangepicker({
            ...
            function (start, end) {
                $('#defaultrange_modal input').val(start.format('DDDD M, YYYY') + ' - ' + end.format('DDDD M, YYYY'));
            }
        );
        ...
        $('#reportrange span').html(moment().subtract('days', 29).format('DDDD M, YYYY') + ' - ' + moment().format('DDDD M, YYYY'));
    }
